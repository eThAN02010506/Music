 ...
 * The backend already validates answer/guide language; this is depth-of-defense
 * so a stray foreign-language paragraph cannot leak into the visible copy.
 */
export function localizedProse(
  ...
  return matchesUiLanguage(text, locale) ? text : placeholder;
}
